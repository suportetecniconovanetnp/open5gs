...
static void eir_disabled_attach_flow(abts_case *tc, void *data)
{
    int rv;
    ...
    ABTS_INT_EQUAL(tc, OGS_NAS_EPS_ESM_INFORMATION_REQUEST, test_ue->esm_message_type);
...
abts_suite *test_eir_disabled(abts_suite *suite)
{
    ...
    abts_run_test(suite, eir_disabled_attach_flow, NULL);
